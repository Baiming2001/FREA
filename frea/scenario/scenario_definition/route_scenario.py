        ...
        if self._is_custom_scenario_type(2):
            ...
            outcome_profiles = {
                'collision': {
                    ...
                    'other_start_boost_mps': 5.0,
                    'other_start_boost_speed_threshold_mps': 6.0,
                    'ego_clear_distance_m': 18.0,
                    'ego_reaction_delay_seconds': 2.5,
                    'ego_min_throttle_during_delay': 0.35,
                    'ego_force_no_brake_distance_m': 14.0,
                    'ego_max_brake_during_collision_window': 0.12,
                },
                'normal': {
