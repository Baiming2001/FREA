    ...
    def _get_scenario_parameters(self):
        ...
        if self._is_custom_scenario_type(1):
            scenario1_defaults = {
                ...
                'other_follow_speed_offset_mps': 0.15,
                'other_min_follow_distance_m': 6.5,
                'other_desired_rear_gap_m': 9.5,
                'other_far_follow_extra_mps': 0.5,
                'other_far_follow_distance_m': 14.0,
                'other_close_speed_penalty_mps': 0.35,
                'other_start_boost_mps': 1.4,
                'other_start_boost_speed_threshold_mps': 3.0,
                'other_max_catchup_speed_delta_mps': 0.35,
            ...
            outcome_profiles = {
                'collision': {
                    ...
                    'other_follow_speed_offset_mps': 0.1,
                    'other_min_follow_distance_m': 7.0,
                    'other_desired_rear_gap_m': 9.0,
                    'other_far_follow_extra_mps': 0.4,
                    'other_far_follow_distance_m': 15.0,
                    'other_close_speed_penalty_mps': 0.45,
                    'other_start_boost_mps': 1.2,
                    'other_start_boost_speed_threshold_mps': 3.5,
                    'other_max_catchup_speed_delta_mps': 0.25,
                    'ego_loss_trigger_seconds': 6.0,
        ...
        if self._is_custom_scenario_type(2):
            ...
            scenario2_defaults = {
                ...
                'leading_release_advance_probability': 0.0,
                'leading_release_advance_seconds_min': 0.0,
                'leading_release_advance_seconds_max': 0.0,
                'leading_release_advance_seconds': 0.4,
                'leading_release_advance_random_seconds_max': 0.0,
                'leading_target_speed_mps': 7.0,
                'leading_post_merge_speed_mps': 8.0,
                'leading_merge_speed_mps': 2.0,
                'leading_merge_distance_m': 4.0,
                'leading_release_initial_speed_mps': 0.45,
                'leading_release_ramp_seconds': 2.0,
            ...
            outcome_profiles = {
                'collision': {
                    ...
                    'leading_release_advance_probability': 0.5,
                    'leading_release_advance_seconds_min': 0.2,
                    'leading_release_advance_seconds_max': 0.4,
                    'leading_release_advance_seconds': 0.4,
                    'leading_release_advance_random_seconds_max': 0.0,
